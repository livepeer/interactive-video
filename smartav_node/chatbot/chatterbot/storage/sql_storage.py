from chatbot.chatterbot.storage import StorageAdapter
from face_recognition.face_detection.common import make_database_url_from_env
...
class SQLStorageAdapter(StorageAdapter):
    ...
    def __init__(self, **kwargs):
        ...
        self.database_uri = make_database_url_from_env()
    ...
    def get_statement_model(self):
        ...
        """
        from chatbot.chatterbot.ext.sqlalchemy_app.models import Statement
        return Statement
    ...
    def get_tag_model(self):
        ...
        """
        from chatbot.chatterbot.ext.sqlalchemy_app.models import Tag
        return Tag

    def model_to_object(self, statement):
        from chatbot.chatterbot.conversation import Statement as StatementObject
    ...
    def create_database(self):
        ...
        """
        from chatbot.chatterbot.ext.sqlalchemy_app.models import Base
