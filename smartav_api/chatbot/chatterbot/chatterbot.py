...
from chatbot.chatterbot.search import TextSearch, IndexedTextSearch
from chatbot.chatterbot import utils
...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'chatbot.chatterbot.storage.SQLStorageAdapter')

        logic_adapters = kwargs.get('logic_adapters', [
            'chatbot.chatterbot.logic.BestMatch'
        ])
        ...
        preprocessors = kwargs.get(
            'preprocessors', [
                'chatbot.chatterbot.preprocessors.clean_whitespace'
            ]
        )
