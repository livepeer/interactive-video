...
from chatbot.chatterbot.conversation import Statement
from chatbot.chatterbot.tagging import PosLemmaTagger
...
class ChatterBotCorpusTrainer(Trainer):
    ...
    def train(self, *corpus_paths):
        ...
        from chatbot.chatterbot.corpus import load_corpus, list_corpus_files
        ...
        for corpus, categories, file_path in load_corpus(*data_file_paths):
            ...
            for conversation_count, conversation in enumerate(corpus):
                ...
                if 'text' not in conversation or 'question' not in conversation:
                    continue
                ...
                statement_search_text = self.chatbot.storage.tagger.get_text_index_string(question)
